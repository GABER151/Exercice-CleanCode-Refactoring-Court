...
class CompanyPayrollTest {
    ...
    void hourlyRaiseShouldRaiseHourlySalary() {
        ...
        company.giveSalaryRaise(hourlyEmployee, RAISE);
    ...
    void salariedRaiseShouldRaiseMonthlySalary() {
        ...
        company.giveSalaryRaise(salariedEmployee, RAISE);
    ...
    void negativeRaiseShouldThrow() {
        ...
        Assert.assertThrows(RuntimeException.class, () -> company.giveSalaryRaise(eng, -1));
    }

    @Test
    void cannotGiveRaiseIfNotInCompany() {
        Assert.assertThrows(RuntimeException.class, () -> company.giveSalaryRaise(eng, 10));
    }
    ...
    void avgPayCehck_pending() {
        ...
        float avg = company.getAvgPayCheckPending();
